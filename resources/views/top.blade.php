...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/feedMe.css">
    ...
    <body>
        <div class="message">
            <h1>Unforgettable, immersive <br>culinary experiences</h1>
            <p>From home or abroad, join intimate culinary experiences <br> led by passionate hosts and chefs that will take your breath away.</p>
        </div>
        <form class="search" action="{{ route('search') }}" method="post">
            @csrf
            <input type="text" name="freeword" placeholder="Search for free ...">
        ...
        @if(isset($events))
            <div class="event_result_container">
                @foreach($events as $event)
                    ...
                    special_diet:{{$event['special_diet']}}/ 
                    content:{{$event['content']}}/ 
                    available_date[D]:{{$event['avalable_date']}}
                    <img src="/img/{{}}">
                    <br>
